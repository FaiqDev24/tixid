                ...
                <tr>
                    ...
                    <td>
                        @php
                            ...
                            sort($hours);
                            urutkan array secara ascending (pagi → malam)
                        @endphp
                        <ul>
        ...
        $(function() {
            $('#scheduleTables').DataTable({
                ...
                columns: [
                    ...
                    { data: 'cinema_id', name: 'cinema_id', orderable: true, searchable: true },
                    { data: 'movie_id', name: 'movie_id', orderable: true, searchable: true },
