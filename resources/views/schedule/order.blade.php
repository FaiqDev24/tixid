...
@section('content')
    <div class="container card my-5 p-4">
        ...
        <div class="card-body">
            <div class="d-flex my-5">
                <img src="{{ asset('storage/' . $ticket['schedule']['movie']['poster']) }}" alt="" width="120">
                <div class="ms-3">
            ...
            <table>
                <tr>
                    ...
                    {{-- implode : mengubah array jadi string, dipisahkan dengan tanda tertentu --}}
            ...
            <select id="promo_id" class="form-select" onchange="selectPromo()">
                <option disable hidden>Pilih Promo</option>
    ...
    <div class="fixed-bottom w-100 p-2 text-center text-white" style="background: #112646" onclick="createQrcode()"><b>BAYAR
            SEKARANG</b></div>
@endsection
...
@push('script')
    <script>
        ...
        function selectPromo() {
            // update promoId diatas enjadi value dari select id="promo_id"
