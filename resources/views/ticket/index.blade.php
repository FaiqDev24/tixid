                ...
                <div class="container mt-4">
                    ...
                    <div class="d-flex flex-wrap">
                        @foreach ($ticketActive as $active)
                            <div class="w-25 me-3 mb-3"
                                style="border: 1px solid #eaeaea; padding: 8px; border-radius: 5px;">
                    ...
                    <div class="d-flex flex-wrap">
                        @foreach ($ticketNonActive as $nonActive)
                            <div class="w-25 me-3 mb-3"
                                ...
                                <br>
                                <p>Tanggal : <span
                                        class="text-danger">{{ \Carbon\Carbon::parse($nonActive['ticketPayment']['booked_date'])->format('d F,Y') }}</span>
                                </p>
                                <p>Waktu : {{ \Carbon\Carbon::parse($nonActive['hour_id'])->format('H:i') }} WIB</p>
